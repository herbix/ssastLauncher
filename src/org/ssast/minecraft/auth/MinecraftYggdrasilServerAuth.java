...
public class MinecraftYggdrasilServerAuth extends ServerAuth {
	...
	public void login(final AuthDoneCallback callback) {
		...
		String token = "SSASTLauncher:" + this.profiles.getClientToken();
		...
		if(result == null) {
			...
			if(stored.isEmpty() || JOptionPane.YES_OPTION !=
					JOptionPane.showConfirmDialog(null, Lang.getString("msg.yggdrasil.saved"), "SSAST Launcher", JOptionPane.YES_NO_OPTION)) {
